...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView textViewSwitchToLogin = findViewById(R.id.loginText);
    ...
    private void registerUser() {
        EditText etFirstName = findViewById(R.id.etRegisterFirstName);
        EditText etLastName = findViewById(R.id.etRegisterLastName);
